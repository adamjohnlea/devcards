...
3. `computeStats(repos)` → total stars (all repos) + languages sorted by frequency (forks excluded, since a fork's language is the upstream project's)
